!((e) => {
	"function" == typeof define && define.amd
		? define(["jquery"], (t) => e(t, window, document))
	...
	function A(t) {
		...
		e.each(t, (e, l) => {
			(r = e.match(/^([^A-Z]+?)([A-Z])/)),
				r &&
					-1 !== a.indexOf(r[1] + " ") &&
					((n = e.replace(r[0], r[2].toLowerCase())),
					(i[n] = e),
					"o" === r[1] && A(t[e]));
		}),
			(t._hungarianMap = i);
		...
		e.each(a, (l, o) => {
			(i = t._hungarianMap[l]),
				i === r ||
					(!n && a[i] !== r) ||
					("o" === i.charAt(0)
						? (a[i] || (a[i] = {}), e.extend(!0, a[i], a[l]), F(t[i], a[i], n))
						: (a[i] = a[l]));
		});
	}
	function L(e) {
		...
		if ((a && Xt(a), e)) {
			...
			!e.sEmptyTable &&
				...
				ct(e, e, "sZeroRecords", "sEmptyTable"),
				!e.sLoadingRecords &&
					r &&
					"Loading..." === t.sLoadingRecords &&
					ct(e, e, "sZeroRecords", "sLoadingRecords"),
	...
	function R(e) {
		P(e, "ordering", "bSort"),
			P(e, "orderMulti", "bSortMulti"),
			P(e, "orderClasses", "bSortClasses"),
			P(e, "orderCellsTop", "bSortCellsTop"),
			P(e, "order", "aaSorting"),
			P(e, "orderFixed", "aaSortingFixed"),
			P(e, "paging", "bPaginate"),
			P(e, "pagingType", "sPaginationType"),
			P(e, "pageLength", "iDisplayLength"),
			P(e, "searching", "bFilter"),
	...
	function N(a) {
		if (!n.__browser) {
			...
			var i = e("<div/>")
				...
				l = i.children(),
				o = l.children();
			(r.barWidth = l[0].offsetWidth - l[0].clientWidth),
				(r.bScrollOversize =
					100 === o[0].offsetWidth && 100 !== l[0].clientWidth),
				(r.bScrollbarLeft = 1 !== Math.round(o.offset().left)),
				(r.bBounding = i[0].getBoundingClientRect().width ? !0 : !1),
				i.remove();
		}
		e.extend(a.oBrowser, n.__browser),
	...
	function O(t, a, i) {
		...
		i !== r &&
			null !== i &&
			(j(i),
			F(n.defaults.column, i),
			i.mDataProp === r || i.mData || (i.mData = i.mDataProp),
			i.sType && (l._sManualType = i.sType),
			i.className && !i.sClass && (i.sClass = i.className),
			i.sClass && s.addClass(i.sClass),
			e.extend(l, i),
			ct(l, i, "sWidth", "sWidthOrig"),
			i.iDataSort !== r && (l.aDataSort = [i.iDataSort]),
			ct(l, i, "aDataSort"));
		var f = l.mData,
			c = ee(f),
			d = l.mRender ? ee(l.mRender) : null,
			h = (e) => "string" == typeof e && -1 !== e.indexOf("@");
		(l._bAttrSrc =
			e.isPlainObject(f) && (h(f.sort) || h(f.type) || h(f.filter))),
			(l._setter = null),
			(l.fnGetData = (e, t, a) => {
				var n = c(e, t, r, a);
				return d && t ? d(n, t, e, a) : n;
			}),
			(l.fnSetData = (e, t, a) => te(f)(e, t, a)),
			"number" != typeof f && (t._rowReadObject = !0),
			t.oFeatures.bSort || ((l.bSortable = !1), s.addClass(o.sSortableNone));
		var p = -1 !== e.inArray("asc", l.asSorting),
			v = -1 !== e.inArray("desc", l.asSorting);
		l.bSortable && (p || v)
			? p && !v
				? ((l.sSortingClass = o.sSortableAsc),
					(l.sSortingClassJUI = o.sSortJUIAscAllowed))
				: !p && v
					? ((l.sSortingClass = o.sSortableDesc),
						(l.sSortingClassJUI = o.sSortJUIDescAllowed))
					: ((l.sSortingClass = o.sSortable), (l.sSortingClassJUI = o.sSortJUI))
			: ((l.sSortingClass = o.sSortableNone), (l.sSortingClassJUI = ""));
	}
	function M(e) {
		if (e.oFeatures.bAutoWidth !== !1) {
			...
			$e(e);
			for (var a = 0, r = t.length; r > a; a++)
				t[a].nTh.style.width = t[a].sWidth;
		}
		var n = e.oScroll;
	...
	function V(e) {
		...
		for (l = 0, o = t.length; o > l; l++)
			if (((d = t[l]), (v = []), !d.sType && d._sManualType))
			...
			for (l = a.length - 1; l >= 0; l--) {
				...
				for (e.isArray(p) || (p = [p]), s = 0, u = p.length; u > s; s++)
					if ("number" == typeof p[s] && p[s] >= 0) {
						...
						for (f = 0, c = h.length; c > f; f++)
							("_all" == p[s] || e(h[f].nTh).hasClass(p[s])) && i(f, d);
			}
	...
	function J(t, a, i, l) {
		...
		for (var c = t.aoColumns, d = 0, h = c.length; h > d; d++)
			c[d].sType = null;
		t.aiDisplayMaster.push(o);
		var p = t.rowIdFn(a);
		return (
			p !== r && (t.aIds[p] = s),
			(i || !t.oFeatures.bDeferRender) && oe(t, o, i, l),
			o
		);
	}
	function q(t, a) {
		...
		return (
			...
			a.map((e, a) => ((r = le(t, a)), J(t, r.data, a, r.cells)))
		);
	}
	function G(e, t) {
	...
	function ee(t) {
		...
		if (null === t) return (e) => e;
		if ("function" == typeof t) return (e, a, r, n) => t(e, a, r, n);
		if (
			"string" != typeof t ||
			(-1 === t.indexOf(".") && -1 === t.indexOf("[") && -1 === t.indexOf("("))
		)
			return (e, a) => e[t];
		var n = (t, a, i) => {
			var l, o, s, u;
				...
				if (((u = l[h].match(Z)), (f = l[h].match(Q)), u)) {
					if (
						...
						for (var v = 0, g = n.length; g > v; v++)
							(c = {}), a(c, n[v], d), t[l[h]].push(c);
					else t[l[h]] = n;
					return;
				}
				f && ((l[h] = l[h].replace(Q, "")), (t = t[l[h]](n))),
					(null === t[l[h]] || t[l[h]] === r) && (t[l[h]] = {}),
					(t = t[l[h]]);
			}
	...
	function ne(e, t, a) {
		for (var n = -1, i = 0, l = e.length; l > i; i++)
			e[i] == t ? (n = i) : e[i] > t && e[i]--;
	...
	function ie(e, t, a, n) {
		...
		if ("dom" !== a && ((a && "auto" !== a) || "dom" !== i.src)) {
			...
			if (u)
				if (n !== r) s(u[n], n);
				else for (l = 0, o = u.length; o > l; l++) s(u[l], l);
			...
			g = (t) => {
				if (n === r || n === c)
					if (((u = h[c]), (d = e.trim(t.innerHTML)), u && u._bAttrSrc)) {
						...
						p
							? (u._setter || (u._setter = te(u.mData)), u._setter(i, d))
							: (i[c] = d);
				c++;
			};
		if (o)
			for (; o; )
				(s = o.nodeName.toUpperCase()),
					("TD" == s || "TH" == s) && (g(o), l.push(o)),
					(o = o.nextSibling);
		else {
			l = a.anCells;
	...
	function oe(t, r, n, i) {
		...
		if (null === l.nTr) {
			for (
				...
				(c = t.aoColumns[d]),
					(f = n ? i[d] : a.createElement(c.sCellType)),
					(f._DT_CellIndex = { row: r, column: d }),
					s.push(f),
					(n && !c.mRender && c.mData === d) ||
						(e.isPlainObject(c.mData) && c.mData._ === d + ".display") ||
						(f.innerHTML = z(t, r, d, "display")),
					c.sClass && (f.className += " " + c.sClass),
					c.bVisible && !n
						? u.appendChild(f)
						: !c.bVisible && n && f.parentNode.removeChild(f),
					c.fnCreatedCell &&
						c.fnCreatedCell.call(t.oInstance, f, z(t, r, d), o, r, d);
	...
	function se(t, a) {
		...
		if (r) {
			...
			if ((i && (r.id = i), n.DT_RowClass)) {
				...
				(a.__rowc = a.__rowc ? I(a.__rowc.concat(l)) : l),
					e(r).removeClass(a.__rowc.join(" ")).addClass(n.DT_RowClass);
			}
			n.DT_RowAttr && e(r).attr(n.DT_RowAttr),
				n.DT_RowData && e(r).data(n.DT_RowData);
		}
	}
	function ue(t) {
		var a,
			...
			f = t.oClasses,
			c = t.aoColumns;
		for (u && (i = e("<tr/>").appendTo(o)), a = 0, r = c.length; r > a; a++)
			(l = c[a]),
				(n = e(l.nTh).addClass(l.sClass)),
				u && n.appendTo(i),
				t.oFeatures.bSort &&
					(n.addClass(l.sSortingClass),
					l.bSortable !== !1 &&
						(n.attr("tabindex", t.iTabIndex).attr("aria-controls", t.sTableId),
						nt(t, l.nTh, a))),
				l.sTitle != n[0].innerHTML && n.html(l.sTitle),
				bt(t, "header")(t, n, l, f);
		if (
			(u && pe(t.aoHeader, o),
			e(o).find(">tr").attr("role", "row"),
			e(o).find(">tr>th, >tr>td").addClass(f.sHeaderTH),
			e(s).find(">tr>th, >tr>td").addClass(f.sFooterTH),
			null !== s)
		) {
			var d = t.aoFooter[0];
			for (a = 0, r = d.length; r > a; a++)
				(l = c[a]),
					(l.nTf = d[a].cell),
					l.sClass && e(l.nTf).addClass(l.sClass);
		}
	}
	function fe(t, a, n) {
		var i,
		...
		if (a) {
			for (n === r && (n = !1), i = 0, l = a.length; l > i; i++) {
				for (h[i] = a[i].slice(), h[i].nTr = a[i].nTr, o = v - 1; o >= 0; o--)
					t.aoColumns[o].bVisible || n || h[i].splice(o, 1);
				p.push([]);
			}
			for (i = 0, l = h.length; l > i; i++) {
				...
				for (o = 0, s = h[i].length; s > o; o++)
					if (((g = 1), (b = 1), p[i][o] === r)) {
						for (
							d.appendChild(h[i][o].cell), p[i][o] = 1;
							h[i + g] !== r && h[i][o].cell == h[i + g][o].cell;
						)
							(p[i + g][o] = 1), g++;
	...
	function ce(t) {
		...
		(t.bDrawing = !0),
			h !== r &&
				-1 !== h &&
				((t._iDisplayStart = p ? h : h >= t.fnRecordsDisplay() ? 0 : h),
		...
		if (0 !== v.length)
			for (var m = p ? 0 : g, S = p ? t.aoData.length : b, D = m; S > D; D++) {
				...
				if (0 !== f) {
					var T = u[s % f];
					_._sRowStripe != T &&
						(e(w).removeClass(_._sRowStripe).addClass(T), (_._sRowStripe = T));
				}
			...
			1 == t.iDraw && "ajax" == mt(t)
				? (C = d.sLoadingRecords)
				: d.sEmptyTable && 0 === t.fnRecordsTotal() && (C = d.sEmptyTable),
				(o[0] = e("<tr/>", { class: f ? u[0] : "" }).append(
					e("<td />", {
						valign: "top",
						colSpan: E(t),
	...
	function de(e, t) {
		var a = e.oFeatures,
			...
			n = a.bFilter;
		r && tt(e),
			n ? _e(e, e.oPreviousSearch) : (e.aiDisplay = e.aiDisplayMaster.slice()),
		...
		for (var u, f, c, d, h, p, s = t.sDom.split(""), v = 0; v < s.length; v++) {
			if (((u = null), (f = s[v]), "<" == f)) {
				if (((c = e("<div/>")[0]), (d = s[v + 1]), "'" == d || '"' == d)) {
					...
					if (
						("H" == h ? (h = a.sJUIHeader) : "F" == h && (h = a.sJUIFooter),
						-1 != h.indexOf("."))
					) {
						var g = h.split(".");
		...
		for (l = 0, u = r.length; u > l; l++)
			for (n = r[l], d = 0, i = n.firstChild; i; ) {
				if (
					...
					for (
						h = 1 * i.getAttribute("colspan"),
							p = 1 * i.getAttribute("rowspan"),
							h = h && 0 !== h && 1 !== h ? h : 1,
							p = p && 0 !== p && 1 !== p ? p : 1,
							c = g(t, l, d),
							v = 1 === h ? !0 : !1,
						...
						for (o = 0; p > o; o++)
							(t[l + o][c + s] = { cell: i, unique: v }), (t[l + o].nTr = n);
				i = i.nextSibling;
			}
	}
	function ve(e, t, a) {
		...
		for (var n = 0, i = a.length; i > n; n++)
			for (var l = 0, o = a[n].length; o > l; l++)
				!a[n][l].unique || (r[l] && e.bSortCellsTop) || (r[l] = a[n][l].cell);
		return r;
	}
	function ge(t, a, r) {
		...
		var c = {
			...
			error: (a, r, n) => {
				...
				-1 === e.inArray(!0, i) &&
					("parsererror" == r
						? ft(t, 0, "Invalid JSON response", 1)
						: 4 === a.readyState && ft(t, 0, "Ajax error", 7)),
					Ve(t, !1);
			},
		};
		(t.oAjaxData = a),
			vt(t, null, "preXhr", [t, a]),
			t.fnServerData
				? t.fnServerData.call(
						s,
						t.sAjaxSource,
						e.map(a, (e, t) => ({ name: t, value: e })),
						u,
						t,
					)
				: t.sAjaxSource || "string" == typeof o
					? (t.jqXHR = e.ajax(e.extend(c, { url: o || t.sAjaxSource })))
					: "function" == typeof o
						? (t.jqXHR = o.call(s, a, u, t))
						: ((t.jqXHR = e.ajax(e.extend(c, o))), (o.data = l));
	}
	function be(e) {
	...
	function me(t) {
		...
		for (s = 0; r > s; s++)
			(c = a[s]),
				(d = o[s]),
				(f = "function" == typeof c.mData ? "function" : c.mData),
				b.columns.push({
					data: f,
					name: c.sName,
				...
				g("mDataProp_" + s, f),
				i.bFilter &&
					(g("sSearch_" + s, d.sSearch),
					g("bRegex_" + s, d.bRegex),
					g("bSearchable_" + s, c.bSearchable)),
				i.bSort && g("bSortable_" + s, c.bSortable);
		i.bFilter && (g("sSearch", l.sSearch), g("bRegex", l.bRegex)),
			i.bSort &&
				(e.each(h, (e, t) => {
					b.order.push({ column: t.col, dir: t.dir }),
						g("iSortCol_" + e, t.col),
						g("sSortDir_" + e, t.dir);
				}),
	...
	function ye(t) {
		...
		var f = e("<div/>", {
			...
			h = e("input", f)
				...
				.on("keyup.DT search.DT input.DT paste.DT cut.DT", d ? ze(c, d) : c)
				.on("keypress.DT", (e) => (13 == e.keyCode ? !1 : void 0))
				.attr("aria-controls", n);
		return (
			e(t.nTable).on("search.dt.DT", (e, r) => {
				if (t === r)
					try {
	...
	function _e(e, t, a) {
		var n = e.oPreviousSearch,
			...
			o = (e) => (e.bEscapeRegex !== r ? !e.bEscapeRegex : e.bRegex);
		if ((V(e), "ssp" != mt(e))) {
			Ce(e, t.sSearch, a, o(t), t.bSmart, t.bCaseInsensitive), l(t);
			for (var s = 0; s < i.length; s++)
				Te(e, i[s].sSearch, s, o(i[s]), i[s].bSmart, i[s].bCaseInsensitive);
			we(e);
		} else l(t);
	...
	function we(t) {
		for (
			var i, l, a = n.ext.search, r = t.aiDisplay, o = 0, s = a.length;
			s > o;
			o++
		) {
			for (var u = [], f = 0, c = r.length; c > f; f++)
				(l = r[f]),
					(i = t.aoData[l]),
					a[o](t, i._aFilterData, l, i._aData, f) && u.push(l);
	...
	function Te(e, t, a, r, n, i) {
		if ("" !== t) {
			for (
				var l, o = [], s = e.aiDisplay, u = xe(t, r, n, i), f = 0;
				f < s.length;
				f++
			)
				(l = e.aoData[s[f]]._aFilterData[a]), u.test(l) && o.push(s[f]);
			e.aiDisplay = o;
		}
	}
	function Ce(e, t, a, r, i, l) {
		var f,
			...
			u = e.aiDisplayMaster,
			h = [];
		if ((0 !== n.ext.search.length && (a = !0), (c = Le(e)), t.length <= 0))
			e.aiDisplay = u.slice();
		else {
			for (
				(c || a || s.length > t.length || 0 !== t.indexOf(s) || e.bSorted) &&
					(e.aiDisplay = u.slice()),
					f = e.aiDisplay,
					d = 0;
				d < f.length;
				...
				o.test(e.aoData[f[d]]._sFilterRow) && h.push(f[d]);
			e.aiDisplay = h;
		}
	}
	function xe(t, a, r, n) {
		if (((t = a ? t : Ie(t)), r)) {
			var i = e.map(t.match(/"[^"]+"|[^ ]+/g) || [""], (e) => {
				if ('"' === e.charAt(0)) {
					var t = e.match(/^"(.*)"$/);
					e = t ? t[1] : e;
				}
	...
	function Le(e) {
		...
		for (r = 0, l = e.aoData.length; l > r; r++)
			if (((f = e.aoData[r]), !f._aFilterData)) {
				for (s = [], i = 0, o = t.length; o > i; i++)
					(a = t[i]),
						a.bSearchable
							? ((u = z(e, r, i, "filter")),
								c[a.sType] && (u = c[a.sType](u)),
								null === u && (u = ""),
								"string" != typeof u && u.toString && (u = u.toString()))
							: (u = ""),
						u.indexOf &&
							-1 !== u.indexOf("&") &&
							((Ae.innerHTML = u), (u = Fe ? Ae.textContent : Ae.innerText)),
	...
	function je(t) {
		...
		return (
			r ||
				(t.aoDrawCallback.push({ fn: Ne, sName: "information" }),
				n.attr("role", "status").attr("aria-live", "polite"),
				e(t.nTable).attr("aria-describedby", a + "_info")),
			n[0]
		);
	}
	function Ne(t) {
	...
	function He(e, t) {
		...
		return t
			...
			.replace(/_PAGE_/g, a.call(e, l ? 1 : Math.ceil(r / n)))
			.replace(/_PAGES_/g, a.call(e, l ? 1 : Math.ceil(i / n)));
	}
	function ke(e) {
		var t,
			a,
		...
		for (
			...
			(i = n[t]), i.sWidth && (i.nTh.style.width = Ke(i.sWidth));
	...
	function Oe(e, t) {
		(e._bInitComplete = !0),
			(t || e.oInit.aaData) && M(e),
			vt(e, null, "plugin-init", [e, t]),
			vt(e, "aoInitComplete", "init", [e, t]);
	}
	function Me(e, t) {
		var a = parseInt(t, 10);
	...
	function We(t) {
		for (
			...
			s[0][u] = new Option(
				"number" == typeof o[u] ? t.fnFormatNumber(o[u]) : o[u],
				l[u],
			);
		...
		return (
			...
			e(t.nTable).on("length.dt.DT", (a, r, n) => {
					...
					fn: (e) => {
						if (i) {
							var d,
								...
								f = o ? 1 : Math.ceil(n / a),
								c = r(u, f);
							for (d = 0, h = s.p.length; h > d; d++)
								bt(e, "pageButton")(e, s.p[d], d, c, u, f);
						} else r.fnUpdate(e, l);
					},
					sName: "pagination",
				})),
				...
				: "first" == t
					...
					: "previous" == t
						...
						: "next" == t
							? i > r + n && (r += n)
							: "last" == t
								? (r = Math.floor((i - 1) / n) * n)
								: ft(e, 0, "Unknown paging action: " + t, 5);
		var l = e._iDisplayStart !== r;
		return (
			(e._iDisplayStart = r), l && (vt(e, null, "page", [e]), a && ce(e)), l
		);
	}
	function Ue(t) {
		return e("<div/>", {
	...
	function Ve(t, a) {
		t.oFeatures.bProcessing &&
			e(t.aanFeatures.r).css("display", a ? "block" : "none"),
			vt(t, null, "processing", [t, a]);
	}
	function Xe(t) {
		var a = e(t.nTable);
		a.attr("role", "grid");
		...
		var n = r.sX,
			...
			h = (e) => (e ? Ke(e) : null);
		c.length || (c = null);
		var p = e(d, { class: l.sScrollWrapper })
			.append(
				e(d, { class: l.sScrollHead })
					.css({
						overflow: "hidden",
						position: "relative",
						border: 0,
						...
						e(d, { class: l.sScrollHeadInner })
							...
							.append(
								u
									...
									.css("margin-left", 0)
									.append("top" === s ? o : null)
									.append(a.children("thead")),
							),
					),
			)
			.append(
				e(d, { class: l.sScrollBody })
					.css({ position: "relative", overflow: "auto", width: h(n) })
					.append(a),
			);
		c &&
			p.append(
				e(d, { class: l.sScrollFoot })
					.css({ overflow: "hidden", border: 0, width: n ? h(n) : "100%" })
					.append(
						e(d, { class: l.sScrollFootInner }).append(
							f
								.removeAttr("id")
								.css("margin-left", 0)
								.append("bottom" === s ? o : null)
								.append(a.children("tfoot")),
						),
					),
			);
		var v = p.children(),
		...
		return (
			n &&
				e(b).on("scroll.DT", function (e) {
					var t = this.scrollLeft;
					(g.scrollLeft = t), c && (m.scrollLeft = t);
				}),
			e(b).css(i && r.bCollapse ? "max-height" : "height", i),
			(t.nScrollHead = g),
			(t.nScrollBody = b),
			(t.nScrollFoot = m),
	...
	function Je(t) {
		...
		if (t.scrollBarVis !== X && t.scrollBarVis !== r)
			return (t.scrollBarVis = X), void M(t);
		(t.scrollBarVis = X),
			D.children("thead, tfoot").remove(),
			T &&
				((j = T.clone().prependTo(D)), (F = T.find("tr")), (P = j.find("tr"))),
			(R = S.clone().prependTo(D)),
			(A = S.find("tr")),
			(L = R.find("tr")),
			R.find("th, td").removeAttr("tabindex"),
			n || ((v.width = "100%"), (s[0].style.width = "100%")),
			e.each(ve(t, R), (e, a) => {
			...
			"" === n
				? ((w.width = "100%"),
					x &&
						(D.find("tbody").height() > h.offsetHeight ||
							"scroll" == p.css("overflow-y")) &&
						(w.width = Ke(D.outerWidth() - o)),
					(U = D.outerWidth()))
				: "" !== i && ((w.width = Ke(i)), (U = D.outerWidth())),
			qe(V, L),
			qe((t) => {
			...
			T &&
				...
				e(P).height(0)),
			qe((e, t) => {
				(e.innerHTML = '<div class="dataTables_sizing">' + k[t] + "</div>"),
			...
			D.outerWidth() < U
				? ((E =
						h.scrollHeight > h.offsetHeight || "scroll" == p.css("overflow-y")
							? U + o
							: U),
					x &&
						(h.scrollHeight > h.offsetHeight ||
							"scroll" == p.css("overflow-y")) &&
						(w.width = Ke(E - o)),
					("" === n || "" !== i) && ft(t, 1, "Possible column misalignment", 6))
				: (E = "100%"),
			(v.width = Ke(E)),
			(u.width = Ke(E)),
			T && (t.nScrollFoot.style.width = Ke(E)),
			l || (x && (v.height = Ke(_.offsetHeight + o)));
		var J = D.outerWidth();
		...
		(c[G] = q ? o + "px" : "0px"),
			T &&
				((m[0].style.width = Ke(J)),
				(b[0].style.width = Ke(J)),
				(b[0].style[G] = q ? o + "px" : "0px")),
	...
	function qe(e, t, a) {
		for (var l, o, r = 0, n = 0, i = t.length; i > n; ) {
			for (l = t[n].firstChild, o = a ? a[n].firstChild : null; l; )
				1 === l.nodeType && (a ? e(l, o, r) : e(l, r), r++),
					(l = l.nextSibling),
	...
	function $e(a) {
		var v,
			...
			y = D.bScrollOversize,
			_ = r.style.width;
		for (_ && -1 !== _.indexOf("%") && (d = _), v = 0; v < f.length; v++)
			(g = n[f[v]]),
				null !== g.sWidth && ((g.sWidth = Ye(g.sWidthOrig, h)), (p = !0));
		if (y || (!p && !o && !l && u == E(a) && u == c.length))
			...
			for (
				T.find("thead, tfoot").remove(),
					T.append(e(a.nTHead).clone()).append(e(a.nTFoot).clone()),
					T.find("tfoot th, tfoot td").css("width", ""),
					c = ve(a, T.find("thead")[0]),
					v = 0;
				v < f.length;
				v++
			)
			...
			if (a.aoData.length)
				for (v = 0; v < f.length; v++)
					(b = f[v]),
						(g = n[b]),
						e(Ze(a, b)).clone(!1).append(g.sContentPadding).appendTo(C);
			...
			o && s
				...
				: o
					? (T.css("width", "auto"),
						T.removeAttr("width"),
						T.width() < h.clientWidth && d && T.width(h.clientWidth))
					: l
	...
	function Qe(e, t) {
		for (var a, r = -1, n = -1, i = 0, l = e.aoData.length; l > i; i++)
			(a = z(e, i, t, "display") + ""),
				(a = a.replace(Ge, "")),
				(a = a.replace(/&nbsp;/g, " ")),
				a.length > r && ((r = a.length), (n = i));
		return n;
	}
	function Ke(e) {
		return null === e
	...
	function et(t) {
		...
		for (
			...
			for (p = b[a][0], c = f[p].aDataSort, l = 0, o = c.length; o > l; l++)
				(d = c[l]),
					(h = f[d].sType || "string"),
					b[a]._idx === r && (b[a]._idx = e.inArray(b[a][1], f[d].asSorting)),
					s.push({
						src: p,
						col: d,
						dir: b[a][1],
	...
	function tt(e) {
		var t,
			...
			D = (e.aoColumns, 0),
			_ = e.aiDisplayMaster;
		for (V(e), w = et(e), t = 0, a = w.length; a > t; t++)
			(y = w[t]), y.formatter && D++, lt(e, y.col);
				...
				: _.sort((e, t) => {
						...
						for (n = 0; u > n; n++)
							if (
								...
								(a = f[o.col]),
								(r = p[o.col]),
								(s = d[o.type + "-" + o.dir] || d["string-" + o.dir]),
								(l = s(a, r)),
								0 !== l)
							)
								return l;
				...
				s.bSortable
					? (n.length > 0 && n[0].col == l
							? (c.setAttribute(
								...
								(a = u[n[0].index + 1] || u[0]))
							: (a = u[0]),
						(t = f + ("asc" === a ? i.sSortAscending : i.sSortDescending)))
					: (t = f),
	...
	function rt(t, a, n, i) {
		var u,
			...
			f = (t, a) => {
				var n = t._idx;
				return (
					n === r && (n = e.inArray(t[1], s)),
					n + 1 < s.length ? n + 1 : a ? null : 0
				);
			};
		if (
			...
			-1 !== c
				? ((u = f(o[c], !0)),
					null === u && 1 === o.length && (u = 0),
					null === u ? o.splice(c, 1) : ((o[c][1] = s[u]), (o[c]._idx = u)))
				: (o.push([a, s[0], 0]), (o[o.length - 1]._idx = 0));
		} else
			o.length && o[0][0] == a
				? ((u = f(o[0])), (o.length = 1), (o[0][1] = s[u]), (o[0]._idx = u))
				: ((o.length = 0), o.push([a, s[0]]), (o[0]._idx = 0));
	...
	function it(t) {
		...
		if (i.bSort && i.bSortClasses) {
			for (l = 0, o = a.length; o > l; l++)
				(s = a[l].src),
					e(y(t.aoData, "anCells", s)).removeClass(r + (2 > l ? l + 1 : 3));
			for (l = 0, o = n.length; o > l; l++)
				(s = n[l].src),
					e(y(t.aoData, "anCells", s)).addClass(r + (2 > l ? l + 1 : 3));
		}
		t.aLastSort = n;
	}
	function lt(e, t) {
		...
		for (
			var l,
				o,
				s = n.ext.type.order[a.sType + "-pre"],
				u = 0,
				f = e.aoData.length;
			f > u;
			u++
			...
			(l = e.aoData[u]),
				...
				(!l._aSortData[t] || r) &&
					((o = r ? i[u] : z(e, u, t, "sort")),
					(l._aSortData[t] = s ? s(o) : o));
	}
	function ot(t) {
		if (t.oFeatures.bStateSave && !t.bDestroying) {
			var a = {
				...
				columns: e.map(t.aoColumns, (e, a) => ({
					visible: e.bVisible,
					search: Pe(t.aoPreSearchCols[a]),
				})),
			};
			vt(t, "aoStateSaveParams", "stateSaveParams", [t, a]),
				(t.oSavedState = a),
				t.fnStateSaveCallback.call(t.oInstance, t, a);
		}
	}
	function st(t, a, n) {
		var i,
			...
			s = (a) => {
				...
				if (
					((t.oLoadedState = e.extend(!0, {}, a)),
					a.start !== r &&
						((t._iDisplayStart = a.start), (t.iInitDisplayStart = a.start)),
					a.length !== r && (t._iDisplayLength = a.length),
					a.order !== r &&
						((t.aaSorting = []),
						e.each(a.order, (e, a) => {
							t.aaSorting.push(a[0] >= o.length ? [0, a[1]] : a);
						})),
					a.search !== r && e.extend(t.oPreviousSearch, Re(a.search)),
					a.columns)
				)
					for (i = 0, l = a.columns.length; l > i; i++) {
						var f = a.columns[i];
						f.visible !== r && (o[i].bVisible = f.visible),
							f.search !== r && e.extend(t.aoPreSearchCols[i], Re(f.search));
					}
	...
	function dt(t, a, r) {
		...
		for (var i in a)
			Object.hasOwn(a, i) &&
				((n = a[i]),
				e.isPlainObject(n)
					? (e.isPlainObject(t[i]) || (t[i] = {}), e.extend(!0, t[i], n))
					: r && "data" !== i && "aaData" !== i && e.isArray(n)
						? (t[i] = n.slice())
						: (t[i] = n));
		return t;
	}
	...
	function vt(t, a, r, n) {
		...
		if (
			(a &&
				(i = e.map(t[a].slice().reverse(), (e, a) =>
					e.fn.apply(t.oInstance, n),
				)),
			null !== r)
		) {
			var l = e.Event(r + ".dt");
	...
	function Ut(e, t) {
		...
		return (
			r >= t
				? (a = w(0, t))
				: n >= e
					? ((a = w(0, r - 2)), a.push("ellipsis"), a.push(t - 1))
					: e >= t - 1 - n
						? ((a = w(t - (r - 2), t)),
		...
		e.each(
			{
				...
				"num-fmt": (e) => Vt(e, t, p),
				"html-num": (e) => Vt(e, t, c),
				"html-num-fmt": (e) => Vt(e, t, c, p),
			},
			(e, a) => {
				(i.type.order[e + t + "-pre"] = a),
					e.match(/^html-/) && (i.type.search[e + t] = i.type.search.html);
			},
		);
	}
	function qt(e) {
		return function () {
			var t = [ut(this[n.ext.iApiIndex])].concat(
	...
	var i,
			...
			(this.$ = function (e, t) {
				...
				(this.fnDeleteRow = function (e, t, a) {
					var n = this.api(!0),
						...
						o = l.aoData[i[0][0]];
					return (
						i.remove(), t && t.call(this, l, o), (a === r || a) && n.draw(), o
					);
				}),
				...
				(this.fnUpdate = function (e, t, a, n, i) {
					var l = this.api(!0);
					return (
						a === r || null === a ? l.row(t).data(e) : l.cell(t, a).data(e),
						(i === r || i) && l.columns.adjust(),
						(n === r || n) && l.draw(),
						0
					);
				}),
			...
			return (
				this.each(function () {
					...
					R(b),
						j(b.column),
						F(b, b, !0),
						F(b.column, b.column, !0),
						F(b, e.extend(l, m.data()));
					var S = n.settings;
					...
					(null === v || "" === v) &&
						((v = "DataTables_Table_" + n.ext._unique++), (this.id = v));
					...
					(w.nTable = this),
						...
						(w.oInit = l),
						S.push(w),
						(w.oInstance = 1 === a.length ? a : m.dataTable()),
						R(l),
						L(l.oLanguage),
						l.aLengthMenu &&
							!l.iDisplayLength &&
							(l.iDisplayLength = e.isArray(l.aLengthMenu[0])
								? l.aLengthMenu[0][0]
								: l.aLengthMenu[0]),
						(l = dt(e.extend(!0, {}, b), l)),
						ct(w.oFeatures, l, [
						...
						ct(w.oLanguage, l, "fnInfoCallback"),
						pt(w, "aoDrawCallback", l.fnDrawCallback, "user"),
						pt(w, "aoServerParams", l.fnServerParams, "user"),
						pt(w, "aoStateSaveParams", l.fnStateSaveParams, "user"),
						pt(w, "aoStateLoadParams", l.fnStateLoadParams, "user"),
						pt(w, "aoStateLoaded", l.fnStateLoaded, "user"),
						pt(w, "aoRowCallback", l.fnRowCallback, "user"),
						pt(w, "aoRowCreatedCallback", l.fnCreatedRow, "user"),
						pt(w, "aoHeaderCallback", l.fnHeaderCallback, "user"),
						pt(w, "aoFooterCallback", l.fnFooterCallback, "user"),
						pt(w, "aoInitComplete", l.fnInitComplete, "user"),
						pt(w, "aoPreDrawCallback", l.fnPreDrawCallback, "user"),
						(w.rowIdFn = ee(l.rowId)),
						N(w);
					var T = w.oClasses;
					if (
						(e.extend(T, n.ext.classes, l.oClasses),
						m.addClass(T.sTable),
						w.iInitDisplayStart === r &&
							((w.iInitDisplayStart = l.iDisplayStart),
							(w._iDisplayStart = l.iDisplayStart)),
						null !== l.iDeferLoading)
					) {
						w.bDeferLoading = !0;
						var C = e.isArray(l.iDeferLoading);
						(w._iRecordsDisplay = C ? l.iDeferLoading[0] : l.iDeferLoading),
							(w._iRecordsTotal = C ? l.iDeferLoading[1] : l.iDeferLoading);
					}
					var x = w.oLanguage;
					e.extend(!0, x, l.oLanguage),
						x.sUrl &&
							(e.ajax({
								dataType: "json",
								url: x.sUrl,
							...
							(g = !0)),
						null === l.asStripeClasses &&
							(w.asStripeClasses = [T.sStripeOdd, T.sStripeEven]);
					var I = w.asStripeClasses,
						A = m.children("tbody").find("tr").eq(0);
					-1 !==
						e.inArray(
							!0,
							e.map(I, (e, t) => A.hasClass(e)),
						) &&
						(e("tbody tr", this).removeClass(I.join(" ")),
						(w.asDestroyStripes = I.slice()));
					var H,
						P = [],
						M = this.getElementsByTagName("thead");
					if (
						(0 !== M.length && (pe(w.aoHeader, M[0]), (P = ve(w))),
						null === l.aoColumns)
					)
					...
					if (
						(X(w, l.aoColumnDefs, H, (e, t) => {
							O(w, e, t);
						}),
						A.length)
					) {
						var W = (e, t) => (null !== e.getAttribute("data-" + t) ? t : null);
						e(A[0])
							.children("th, td")
							.each((e, t) => {
								var a = w.aoColumns[e];
						...
						E = () => {
							if (l.aaSorting === r) {
								...
								for (u = 0, f = t.length; f > u; u++)
									t[u][1] = w.aoColumns[u].asSorting[0];
							}
							it(w),
								B.bSort &&
									pt(w, "aoDrawCallback", () => {
							...
							var a = m.children("caption").each(function () {
								...
								n = m.children("thead");
							0 === n.length && (n = e("<thead/>").appendTo(m)),
								(w.nTHead = n[0]);
							var i = m.children("tbody");
							0 === i.length && (i = e("<tbody/>").appendTo(m)),
								(w.nTBody = i[0]);
							var o = m.children("tfoot");
							if (
								(0 === o.length &&
									a.length > 0 &&
									("" !== w.oScroll.sX || "" !== w.oScroll.sY) &&
									(o = e("<tfoot/>").appendTo(m)),
								0 === o.length || 0 === o.children().length
									? m.addClass(T.sNoFooter)
									: o.length > 0 &&
										((w.nTFoot = o[0]), pe(w.aoFooter, w.nTFoot)),
								l.aaData)
							)
								for (u = 0; u < l.aaData.length; u++) J(w, l.aaData[u]);
							else
								(w.bDeferLoading || "dom" == mt(w)) &&
									q(w, e(w.nTBody).children("tr"));
					...
					l.bStateSave
						? ((B.bStateSave = !0),
							pt(w, "aoDrawCallback", ot, "state_save"),
							st(w, l, E))
						: E();
				}),
				(a = null),
		...
		y = (e, t, a) => {
			var n = [],
				i = 0,
				l = e.length;
			if (a !== r) for (; l > i; i++) e[i] && e[i][t] && n.push(e[i][t][a]);
			else for (; l > i; i++) e[i] && n.push(e[i][t]);
			return n;
		},
		_ = (e, t, a, n) => {
			var i = [],
				l = 0,
				o = t.length;
			if (n !== r) for (; o > l; l++) e[t[l]][a] && i.push(e[t[l]][a][n]);
			else for (; o > l; l++) i.push(e[t[l]][a]);
			return i;
		},
		w = (e, t) => {
			var n,
		...
		x = (e) => {
			...
			for (
				var t = e.slice().sort(), a = t[0], r = 1, n = t.length;
				n > r;
				r++
			) {
				if (t[r] === a) return !1;
	...
	var P = (e, t, a) => {
		...
		yt = (t) => {
			var a,
				r,
				i = n.settings,
				l = e.map(i, (e, t) => e.nTable);
			return t
				? t.nTable && t.oApi
					? [t]
					: t.nodeName && "table" === t.nodeName.toLowerCase()
						? ((a = e.inArray(t, l)), -1 !== a ? [i[a]] : null)
	...
	(l = function (t, a) {
		...
		if (e.isArray(t)) for (var i = 0, o = t.length; o > i; i++) n(t[i]);
		else n(t);
		(this.context = I(r)),
			a && e.merge(this, a),
		...
		e.extend(l.prototype, {
			...
			filter: function (e) {
				...
				if (Dt.filter) t = Dt.filter.call(this, e, this);
					...
					for (var a = 0, r = this.length; r > a; a++)
						e.call(this, this[a], a, this) && t.push(this[a]);
			...
			iterator: function (e, t, a, n) {
				var o,
					...
					g = this.selector;
				for (
					"string" == typeof e && ((n = a), (a = t), (t = e), (e = !1)),
						s = 0,
						u = d.length;
					u > s;
					s++
					...
					if ("table" === t) (o = a.call(b, d[s], s)), o !== r && i.push(o);
						...
						(o = a.call(b, d[s], this[s], s)), o !== r && i.push(o);
					else if (
						"column" === t ||
						"column-rows" === t ||
						"row" === t ||
						...
						for (
							...
							(v = p[f]),
								(o =
									"cell" === t
										? a.call(b, d[s], v.row, v.column, s, f)
										: a.call(b, d[s], v, s, f, h)),
								o !== r && i.push(o);
				}
				if (i.length || n) {
		...
		(l.extend = (t, a, r) => {
			if (r.length && a && (a instanceof l || a.__dt_wrapper)) {
				...
				for (n = 0, i = r.length; i > n; n++)
					(u = r[n]),
						(a[u.name] =
							"function" == typeof u.val
								? c(t, u.val, u)
								: e.isPlainObject(u.val)
									? {}
									: u.val),
						(a[u.name].__dt_wrapper = !0),
						l.extend(t, a[u.name], u.propExt);
			}
		}),
		(l.register = o =
			(t, a) => {
				if (e.isArray(t))
					...
					for (i = 0, o = s.length; o > i; i++) {
						...
						var h = d(u, f);
						h ||
							((h = { name: f, val: {}, methodExt: [], propExt: [] }),
							u.push(h)),
							i === o - 1 ? (h.val = a) : (u = c ? h.methodExt : h.propExt);
					}
				}
			}),
		(l.registerPlural = s =
	...
	o("tables()", function (e) {
		...
		s("tables().nodes()", "table().node()", function () {
			return this.iterator("table", (e) => e.nTable, 1);
		}),
		s("tables().body()", "table().body()", function () {
			return this.iterator("table", (e) => e.nTBody, 1);
		}),
		s("tables().header()", "table().header()", function () {
			return this.iterator("table", (e) => e.nTHead, 1);
		}),
		s("tables().footer()", "table().footer()", function () {
			return this.iterator("table", (e) => e.nTFoot, 1);
		}),
		s("tables().containers()", "table().container()", function () {
			return this.iterator("table", (e) => e.nTableWrapper, 1);
		}),
		o("draw()", function (e) {
			return this.iterator("table", (t) => {
				"page" === e
					? ce(t)
					: ("string" == typeof e && (e = "full-hold" === e ? !1 : !0),
						de(t, e === !1));
			});
		}),
		o("page()", function (e) {
		...
		o("ajax.url()", function (t) {
			...
			return t === r
				? 0 === a.length
					...
					: ((a = a[0]),
						a.ajax
							? e.isPlainObject(a.ajax)
								? a.ajax.url
								: a.ajax
							: a.sAjaxSource)
				: this.iterator("table", (a) => {
	...
	var Tt = (t, a, n, l, o) => {
			var u,
				...
				v = typeof a;
			for (
				(a && "string" !== v && "function" !== v && a.length !== r) ||
					(a = [a]),
					c = 0,
					d = a.length;
				d > c;
				...
				for (
					...
					(u = n("string" == typeof f[h] ? e.trim(f[h]) : f[h])),
						u && u.length && (s = s.concat(u));
			var g = i.selector[t];
		...
		It = (t, a) => {
			...
			if ("current" == c)
				for (r = t._iDisplayStart, n = t.fnDisplayEnd(); n > r; r++)
					l.push(o[r]);
				...
				if ("none" == u) l = s.slice();
					...
					l = e.map(s, (e) => (Object.hasOwn(d, e) ? null : e));
				}
			} else if ("index" == f || "original" == f)
				for (r = 0, n = t.aoData.length; n > r; r++)
					"none" == u
						? l.push(r)
						: ((i = e.inArray(r, o)),
							((-1 === i && "removed" == u) || (i >= 0 && "applied" == u)) &&
								l.push(r));
			return l;
		},
		At = (t, a, n) => {
			var i,
				l = (a) => {
					...
					if ((i || (i = It(t, n)), null !== l && -1 !== e.inArray(l, i)))
						return [l];
	...
	o("rows()", function (t, a) {
		...
		var n = this.iterator("table", (e) => At(e, t, a), 1);
		return (n.selector.rows = t), (n.selector.opts = a), n;
	}),
		o("rows().nodes()", function () {
			return this.iterator("row", (e, t) => e.aoData[t].nTr || r, 1);
		}),
		o("rows().data()", function () {
			return this.iterator(!0, "rows", (e, t) => _(e.aoData, t, "_aData"), 1);
		}),
		...
		s("rows().invalidate()", "row().invalidate()", function (e) {
			return this.iterator("row", (t, a) => {
				ie(t, a, e);
			});
		}),
		s("rows().indexes()", "row().index()", function () {
			return this.iterator("row", (e, t) => t, 1);
		}),
		...
		o("row().data()", function (t) {
			var a = this.context;
			if (t === r)
				return a.length && this.length ? a[0].aoData[this[0]]._aData : r;
			var n = a[0].aoData[this[0]];
			return (
				(n._aData = t),
				e.isArray(t) && n.nTr.id && te(a[0].rowId)(t, n.nTr.id),
				ie(a[0], this[0], "data"),
				this
			);
		}),
		...
		o("row.add()", function (t) {
			...
			var a = this.iterator("table", (e) =>
				t.nodeName && "TR" === t.nodeName.toUpperCase() ? q(e, t)[0] : J(e, t),
			);
			return this.row(a[0]);
		});
	var Ft = (t, a, r, n) => {
		...
		Pt = (e, t) => {
			...
			if (a.length && e.length) {
				...
				r._details &&
					((r._detailsShow = t),
					t ? r._details.insertAfter(r.nTr) : r._details.detach(),
					Rt(a[0]));
			}
		},
		Rt = (e) => {
			...
			t.off(r + " " + n + " " + i),
				y(o, "_details").length > 0 &&
					...
					t.on(n, (t, a, r, n) => {
						if (e === a)
							for (var i, l = E(a), s = 0, u = o.length; u > s; s++)
								(i = o[s]),
									i._details &&
										i._details.children("td[colspan]").attr("colspan", l);
					}),
					t.on(i, (a, r) => {
						if (e === r)
	...
	o(Ht, function (e, t) {
		...
		return e === r
			...
			: (e === !0
					...
					: e === !1
						? Lt(this)
						: a.length && this.length && Ft(a[0], a[0].aoData[this[0]], e, t),
				this);
	}),
		...
		o(Nt + ".isShown()", function () {
			...
			return e.length && this.length
				? e[0].aoData[this[0]]._detailsShow || !1
				: !1;
		});
					...
					if (u)
						switch (u[2]) {
							...
							case "visible": {
								...
								if (0 > f) {
									var c = e.map(n, (e, t) => (e.bVisible ? t : null));
									return [c[c.length + f]];
								}
								return [W(t, f)];
							}
							case "name":
								return e.map(i, (e, t) => (e === u[1] ? t : null));
							default:
								return [];
						}
		...
		Wt = (t, a, n) => {
			...
			if (l.bVisible !== n) {
				if (n) {
					...
					for (f = 0, c = o.length; c > f; f++)
						(d = o[f].nTr),
							(u = o[f].anCells),
							d && d.insertBefore(u[a], u[h] || null);
				} else e(y(t.aoData, "anCells", a)).detach();
				(l.bVisible = n),
					fe(t, t.aoHeader),
					fe(t, t.aoFooter),
					t.aiDisplay.length ||
						e(t.nTBody).find("td[colspan]").attr("colspan", E(t)),
					ot(t);
			}
		};
	o("columns()", function (t, a) {
		t === r ? (t = "") : e.isPlainObject(t) && ((a = t), (t = "")), (a = Ct(a));
		var n = this.iterator("table", (e) => Mt(e, t, a), 1);
		return (n.selector.cols = t), (n.selector.opts = a), n;
	}),
		s("columns().header()", "column().header()", function (e, t) {
			return this.iterator("column", (e, t) => e.aoColumns[t].nTh, 1);
		}),
		s("columns().footer()", "column().footer()", function (e, t) {
			return this.iterator("column", (e, t) => e.aoColumns[t].nTf, 1);
		}),
		s("columns().data()", "column().data()", function () {
			return this.iterator("column-rows", Ot, 1);
		}),
		s("columns().dataSrc()", "column().dataSrc()", function () {
			return this.iterator("column", (e, t) => e.aoColumns[t].mData, 1);
		}),
		s("columns().cache()", "column().cache()", function (e) {
			return this.iterator(
				"column-rows",
				(t, a, r, n, i) =>
					_(t.aoData, i, "search" === e ? "_aFilterData" : "_aSortData", a),
				1,
			);
		}),
		s("columns().nodes()", "column().nodes()", function () {
			return this.iterator(
				"column-rows",
				(e, t, a, r, n) => _(e.aoData, n, "anCells", t),
				1,
			);
		}),
		s("columns().visible()", "column().visible()", function (e, t) {
			var a = this.iterator("column", (t, a) =>
				e === r ? t.aoColumns[a].bVisible : void Wt(t, a, e),
			);
			return (
				e !== r &&
					(this.iterator("column", (a, r) => {
						vt(a, null, "column-visibility", [a, r, e, t]);
					}),
					(t === r || t) && this.columns.adjust()),
				a
			);
		}),
					...
					for (c = [], d = 0, h = l.length; h > d; d++)
						for (u = l[d], p = 0; f > p; p++)
							(v = { row: u, column: p }),
								n
									? ((g = i[u]),
										a(v, z(t, u, p), g.anCells ? g.anCells[p] : null) &&
											c.push(v))
									: c.push(v);
					return c;
				}
				if (e.isPlainObject(a))
					return a.column !== r && a.row !== r && -1 !== e.inArray(a.row, l)
						? [a]
						: [];
				var o = s
					.filter(a)
					...
					.toArray();
				return o.length || !a.nodeName
					? o
					: ((g = e(a).closest("*[data-dt-row]")),
						g.length
	...
	o("cells()", function (t, a, n) {
		if (
			(e.isPlainObject(t) &&
				(t.row === r ? ((n = t), (t = null)) : ((n = a), (a = null))),
			e.isPlainObject(a) && ((n = a), (a = null)),
			null === a || a === r)
		)
			return this.iterator("table", (e) => Bt(e, t, Ct(n)));
		var o,
			s,
			u,
			f,
		...
		this.iterator(
			...
			(e, t) => {
				for (o = [], s = 0, u = l[t].length; u > s; s++)
					for (f = 0, c = i[t].length; c > f; f++)
						o.push({ row: l[t][s], column: i[t][f] });
			},
			1,
		);
		...
		o("cells().data()", function () {
			return this.iterator("cell", (e, t, a) => z(e, t, a), 1);
		}),
		s("cells().cache()", "cell().cache()", function (e) {
			return (
				(e = "search" === e ? "_aFilterData" : "_aSortData"),
				this.iterator("cell", (t, a, r) => t.aoData[a][e][r], 1)
			);
		}),
		s("cells().render()", "cell().render()", function (e) {
			return this.iterator("cell", (t, a, r) => z(t, a, r, e), 1);
		}),
		s("cells().indexes()", "cell().index()", function () {
			return this.iterator(
				"cell",
				(e, t, a) => ({ row: t, column: a, columnVisible: B(e, a) }),
				1,
			);
		}),
		s("cells().invalidate()", "cell().invalidate()", function (e) {
			return this.iterator("cell", (t, a, r) => {
				ie(t, a, e, r);
			});
		}),
		...
		o("cell().data()", function (e) {
			...
			return e === r
				? t.length && a.length
					? z(t[0], a[0].row, a[0].column)
					: r
				: (Y(t[0], a[0].row, a[0].column, e),
					ie(t[0], a[0].row, "data", a[0].column),
					this);
		}),
		...
		o(["columns().order()", "column().order()"], function (t) {
			return this.iterator("table", (r, n) => {
				var i = [];
				e.each(this[n], (e, a) => {
					i.push([a, t]);
				}),
		...
		s("columns().search()", "column().search()", function (t, a, n, i) {
			return this.iterator("column", (l, o) => {
		...
		(n.versionCheck = n.fnVersionCheck =
			(e) => {
				for (
					var r,
						i,
		...
		(n.isDataTable = n.fnIsDataTable =
			(t) => {
				var a = e(t).get(0),
					r = !1;
				return t instanceof n.Api
					? !0
					: (e.each(n.settings, (t, n) => {
		...
		(n.tables = n.fnTables =
			(t) => {
				...
				var r = e.map(n.settings, (a) =>
					!t || (t && e(a.nTable).is(":visible")) ? a.nTable : void 0,
				);
				return a ? new l(r) : r;
			}),
		(n.camelToHungarian = F),
		o("$()", function (t, a) {
			var r = this.rows(a).nodes(),
				n = e(r);
			return e([].concat(n.filter(t).toArray(), n.find(t).toArray()));
		}),
		e.each(["on", "one", "off"], (t, a) => {
			o(a + "()", function () {
				var t = Array.prototype.slice.call(arguments);
				t[0] = e
					.map(t[0].split(/\s/), (e) => (e.match(/\.dt\b/) ? e : e + ".dt"))
					.join(" ");
		...
		o("data()", function () {
			return this.iterator("table", (e) => y(e.aoData, "_aData")).flatten();
		}),
			...
			return (
				...
				this.iterator("table", (r) => {
					var b,
						...
						h = e(u),
						p = e(r.nTableWrapper),
						v = e.map(r.aoData, (e) => e.nTr);
					(r.bDestroying = !0),
						vt(r, "aoDestroyCallback", "destroy", [r]),
						a || new l(r).columns().visible(!0),
						p.off(".DT").find(":not(tbody *)").off(".DT"),
						e(t).off(".DT-" + r.sInstance),
						s != f.parentNode && (d.children("thead").detach(), d.append(f)),
						c &&
							s != c.parentNode &&
							(d.children("tfoot").detach(), d.append(c)),
						(r.aaSorting = []),
						(r.aaSortingFixed = []),
						it(r),
					...
					d[m](),
						...
						!a &&
							i &&
							(i.insertBefore(s, r.nTableReinsertBefore),
							d.css("width", r.sDestroyWidth).removeClass(o.sTable),
							(b = r.asDestroyStripes.length),
							b &&
		...
		e.each(["column", "row", "cell"], (e, t) => {
			o(t + "s().every()", function (e) {
				var a = this.selector.opts;
				return this.iterator(t, (i, l, o, s, u) => {
					e.call(
						this[t](l, "cell" === t ? o : a, "cell" === t ? a : r),
						l,
						o,
						s,
						u,
		...
		o("i18n()", function (t, a, n) {
			...
			return (
				l === r && (l = a),
				n !== r && e.isPlainObject(l) && (l = l[n] !== r ? l[n] : l._),
				l.replace("%d", n)
			);
		}),
		(n.version = "1.10.18"),
	...
	var Et = n.ext.pager;
	e.extend(Et, {
		simple: (e, t) => ["previous", "next"],
		full: (e, t) => ["first", "previous", "next", "last"],
		numbers: (e, t) => [Ut(e, t)],
		simple_numbers: (e, t) => ["previous", Ut(e, t), "next"],
		full_numbers: (e, t) => ["first", "previous", Ut(e, t), "next", "last"],
		first_last_numbers: (e, t) => ["first", Ut(e, t), "last"],
		_numbers: Ut,
		numbers_length: 7,
	}),
		...
		e.extend(n.ext.type.detect, [
			...
			(e, t) =>
				v(e) || ("string" == typeof e && -1 !== e.indexOf("<")) ? "html" : null,
		]),
		e.extend(n.ext.type.search, {
			html: (e) =>
				v(e) ? e : "string" == typeof e ? e.replace(f, " ").replace(c, "") : "",
			string: (e) => (v(e) ? e : "string" == typeof e ? e.replace(f, " ") : e),
		});
	var Vt = (e, t, a, r) =>
		0 === e || (e && "-" !== e)
			? (t && (e = b(e, t)),
				e.replace && (a && (e = e.replace(a, "")), r && (e = e.replace(r, ""))),
				1 * e)
			: -(1 / 0);
	e.extend(i.type.order, {
		...
		"html-pre": (e) =>
			v(e) ? "" : e.replace ? e.replace(/<.*?>/g, "").toLowerCase() : e + "",
		"string-pre": (e) =>
			v(e)
				? ""
				: "string" == typeof e
					...
					: e.toString
						? e.toString()
						: "",
		"string-asc": (e, t) => (t > e ? -1 : e > t ? 1 : 0),
		"string-desc": (e, t) => (t > e ? 1 : e > t ? -1 : 0),
	}),
		Xt(""),
		e.extend(!0, n.ext.renderer, {
			header: {
				_: (t, a, r, n) => {
					e(t.nTable).on("order.dt.DT", (e, i, l, o) => {
						if (t === i) {
							var s = r.idx;
							a.removeClass(
								r.sSortingClass + " " + n.sSortAsc + " " + n.sSortDesc,
							).addClass(
								"asc" == o[s]
									? n.sSortAsc
									: "desc" == o[s]
				...
				jqueryui: (t, a, r, n) => {
					e("<div/>")
						...
						.append(a.contents())
						.append(
							e("<span/>").addClass(n.sSortIcon + " " + r.sSortingClassJUI),
						)
						.appendTo(a),
						e(t.nTable).on("order.dt.DT", (e, i, l, o) => {
							if (t === i) {
	...
	return (
			...
			number: (e, t, a, r, n) => ({
				display: (i) => {
					...
					return (
						l +
						(r || "") +
						s.toString().replace(/\B(?=(\d{3})+(?!\d))/g, e) +
						u +
						(n || "")
					);
				},
		...
		(e.fn.dataTable = n),
		(n.$ = e),
		(e.fn.dataTableSettings = n.settings),
		(e.fn.dataTableExt = n.ext),
	...
	((e) => {
		"function" == typeof define && define.amd
			? define(["jquery", "datatables.net"], (t) => e(t, window, document))
			: "object" == typeof exports
				? (module.exports = (t, a) => (
						t || (t = window),
						(a && a.fn.dataTable) || (a = require("datatables.net")(t, a).$),
						e(a, t, t.document)
					))
				: e(jQuery, window, document);
	})((e, t, a, r) => {
		...
		return (
			...
			(n.ext.renderer.pageButton.bootstrap = (t, i, l, o, s, u) => {
				var p,
					v,
					m,
					f = new n.Api(t),
							...
							if (((m = r[n]), e.isArray(m))) b(a, m);
								...
								p &&
									((o = e("<li>", {
										...
										.appendTo(a)),
									t.oApi._fnBindAction(o, { action: m }, S),
									g++);
							}
					};
				try {
