...
(($) => {
	...
	HDisplay.prototype.show = function () {
		...
		if (
			parentElement.hasClass("in") ||
			parentElement.hasClass("zmd-hierarchical-displaying")
		)
			return;
	...
	HDisplay.prototype._debug = () => {
		$(document)
			.on("show.zmd.hierarchicalDisplay", (e) => {
				console.log(
					'Event "show.zmd.hierarchicalDisplay". For more information see:',
				);
				console.log(e);
			})
			.on("shown.zmd.hierarchicalDisplay", (e) => {
				console.log(
					'Event "shown.zmd.hierarchicalDisplay". For more information see:',
				);
				console.log(e);
			})
			.on("hide.zmd.hierarchicalDisplay", (e) => {
				console.log(
					'Event "hide.zmd.hierarchicalDisplay". For more information see:',
				);
				console.log(e);
			})
			.on("hidden.zmd.hierarchicalDisplay", (e) => {
				console.log(
					'Event "hidden.zmd.hierarchicalDisplay". For more information see:',
				);
				console.log(e);
			});
	};
	...
	function Plugin(settings) {
		return this.each(function () {
			...
			if (!data) {
				$this.data(
					"zmd.hierarchicalDisplay",
					(data = new HDisplay(this, options)),
				);
			}
