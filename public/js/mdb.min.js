...
(jQuery.easing.jswing = jQuery.easing.swing),
	jQuery.extend(jQuery.easing, {
		...
		easeInBack: function (t, e, n, i, a, r) {
			return (
				null == r && (r = 1.70158), i * (e /= a) * e * ((r + 1) * e - r) + n
			);
		},
		easeOutBack: function (t, e, n, i, a, r) {
			return (
				null == r && (r = 1.70158),
				i * ((e = e / a - 1) * e * ((r + 1) * e + r) + 1) + n
			);
		},
					...
					(n.isWindow = function (t) {
						...
						(n.each = function (t, n, i) {
							var a = 0,
								...
								o = e(t);
							if (i) {
								if (o) for (; r > a && !1 !== n.apply(t[a], i); a++);
								else for (a in t) if (!1 === n.apply(t[a], i)) break;
							} else if (o) for (; r > a && !1 !== n.call(t[a], a, t[a]); a++);
							else for (a in t) if (!1 === n.call(t[a], a, t[a])) break;
							return t;
						}),
										...
										(t = s[a]),
											s !== (i = r[a]) &&
												(c && i && (n.isPlainObject(i) || (e = n.isArray(i)))
													? (e
															? ((e = !1), (o = t && n.isArray(t) ? t : []))
															: (o = t && n.isPlainObject(t) ? t : {}),
														(s[a] = n.extend(c, o, i)))
													: void 0 !== i && (s[a] = i));
							return s;
						}),
				...
				return (function (t, e, n, i) {
						...
						if (t) {
							...
							for (var a = 0; n > a; a++)
								if (v.State.calls[a]) {
									...
									for (
										var m = Math.min((e - h) / d.duration, 1),
											b = 0,
											x = s.length;
										x > b;
										b++
												...
												if ("element" !== M) {
													...
													if (((T.currentValue = P), "tween" === M)) g = P;
														...
														y.Hooks.registered[M] &&
															(r(C).rootPropertyValueCache[_] = y.Normalizations
																.registered[_]
					...
					function u(t, e) {
						...
						for (
							...
							if (
								...
								!0 !== o.loop &&
									(c.queue(h)[1] === i ||
										!/\.velocityQueueEntryFlag/i.test(c.queue(h)[1])) &&
									r(h))
							) {
							...
							s && !0 !== o.loop && s(a),
								r(h) &&
									!0 === o.loop &&
									!e &&
									(c.each(r(h).tweensContainer, function (t, e) {
										/^rotate/.test(t) &&
					...
					if (!(7 >= d)) {
						...
						var y = (v.CSS = {
									...
									if (d)
										for (n in y.Hooks.templates) {
											...
											"Color" === a[0] &&
												(a.push(a.shift()),
												r.push(r.shift()),
												(y.Hooks.templates[n] = [a.join(" "), r.join(" ")]));
										}
									for (n in y.Hooks.templates)
								...
								injectValue: function (t, e, n) {
									...
									if (i) {
										var a,
											...
											o = i[1];
										return (
											((a = (n = y.Hooks.cleanRootPropertyValue(r, n))
												.toString()
											...
											case "extract":
												...
												return (
													y.RegEx.wrappedValueAlreadyExtracted.test(n)
														? (i = n)
														: (i = (i = n.toString().match(y.RegEx.valueUnwrap))
																? i[1].replace(/,(\s+)?/g, " ")
																: n),
													i
												);
							...
							getPropertyValue: function (t, n, a, o) {
								...
								if (y.Hooks.registered[n]) {
									...
									var f, p;
									"transform" !==
										(f = y.Normalizations.registered[n]("name", t)) &&
							...
							setPropertyValue: function (t, n, i, a, o) {
								...
								if ("scroll" === n)
									...
									if (
										...
										r(t) && r(t).isSVG && y.Names.SVGAttribute(n)
											? t.setAttribute(n, i)
											: (t.style[s] = i);
									v.debug >= 2 &&
						...
						y.Hooks.register(),
							...
							(v.hook = function (t, e, n) {
								var o = i;
								return (
									(t = a(t)),
									c.each(t, function (t, a) {
										if ((r(a) === i && v.init(a), n === i))
											o === i && (o = v.CSS.getPropertyValue(a, e));
										else {
						...
						var x = function () {
								...
								function t(t) {
									function h(t, e) {
										...
										return (
											f.isArray(t)
												...
												: (n = t),
											e || (a = a || u.easing),
											f.isFunction(n) && (n = n.call(o, S, C)),
											f.isFunction(r) && (r = r.call(o, S, C)),
											[n || 0, a, r]
										);
									}
									function p(t, e) {
									...
									function g() {
										...
										return (
											null === L.remToPx &&
												(L.remToPx =
													parseFloat(y.getPropertyValue(n.body, "fontSize")) ||
													16),
											null === L.vwToPx &&
									...
									if ("scroll" === P) {
										...
										u.container
											...
											v.debug &&
												console.log("tweensContainer (scroll): ", d.scroll, o);
									} else if ("reverse" === P) {
										if (!r(o).tweensContainer)
											return void c.dequeue(o, u.queue);
										...
										b)) {
											...
											if (
												...
												y.Normalizations.registered[W] !== i
											) {
												((u.display !== i &&
													null !== u.display &&
													"none" !== u.display) ||
													(u.visibility !== i && "hidden" !== u.visibility)) &&
													/opacity|filter/.test(O) &&
													!E &&
													0 !== z &&
													(E = 0),
													u._cacheValues && _ && _[O]
														? (E === i && (E = _[O].endValue + _[O].unitType),
									...
									d.element &&
										...
										R.push(d),
										"" === u.queue &&
											((r(o).tweensContainer = d), (r(o).opts = u)),
										(r(o).isAnimating = !0),
										S === C - 1
							...
							var d,
								...
								k =
									arguments[0] &&
									(arguments[0].p ||
										(c.isPlainObject(arguments[0].properties) &&
											!arguments[0].properties.names) ||
										f.isString(arguments[0].properties));
							if (
								(f.isWrapped(this)
									? ((d = !1), (p = 0), (m = this), (h = this))
									: ((d = !0),
										(p = 1),
										(m = k
								...
								switch (
									...
									case "stop":
										...
										var A = [];
										return (
											c.each(v.State.calls, function (t, e) {
												e &&
													c.each(e[1], function (n, a) {
														var o = w === i ? "" : w;
														return (
															(!0 !== o &&
																e[2].queue !== o &&
																(w !== i || !1 !== e[2].queue)) ||
															void c.each(m, function (n, i) {
																i === a &&
																	((!0 === w || f.isString(w)) &&
																		(c.each(
																			c.queue(i, f.isString(w) ? w : ""),
																			function (t, e) {
								...
								if (
									...
									((O = c.extend({}, v.defaults, w)).loop = parseInt(O.loop)),
									(F = 2 * O.loop - 1),
									O.loop)
								)
									for (var V = 0; F > V; V++) {
						...
						(r.prototype = {
							...
							(r.prototype.setValues = function (t, e) {
								...
								for (n = 0; n < t.length; n++)
									(a = Math.max(0, Math.min(s[t][n], r[t][n]))),
										(r[t][n] = Math.round(a));
							...
							(e.exports = function (t) {
								(t.controllers.bar = t.DatasetController.extend({
									...
									updateElementGeometry: function (t, e, n) {
										...
										(a.horizontal = s),
											(a.base = n ? o : u.base),
											(a.x = s ? (n ? o : u.head) : c.center),
											(a.y = s ? c.center : n ? o : u.head),
											(a.height = s ? c.size : void 0),
											(a.width = s ? void 0 : c.size);
									},
									...
									getRuler: function () {
										...
										for (t = 0, e = this.getMeta().data.length; t < e; ++t)
											u.push(n.getPixelForValue(null, t, a));
										return {
											min: r.isNullOrUndef(n.options.barThickness)
												? (function (t, e) {
														var n,
															i,
															a,
										...
										if (f || (void 0 === f && void 0 !== p))
											for (n = 0; n < t; ++n)
												(i = l.getDatasetMeta(n)).bar &&
													...
													((a = c.getRightValue(d[n].data[e])),
													((h < 0 && a < 0) || (h >= 0 && a > 0)) && (g += a));
										return (
											(r = c.getPixelForValue(g)),
											{
											...
											? e.labels.map(function (n, i) {
													...
													return {
														...
														fillStyle: l.backgroundColor
															? l.backgroundColor
															: u(o.backgroundColor, i, c.backgroundColor),
														strokeStyle: l.borderColor
															? l.borderColor
															: u(o.borderColor, i, c.borderColor),
														lineWidth: l.borderWidth
															? l.borderWidth
															: u(o.borderWidth, i, c.borderWidth),
								...
								callbacks: {
									...
									label: function (t, e) {
										var n = e.labels[t.index],
											i = ": " + e.datasets[t.datasetIndex].data[t.index];
										return (
											r.isArray(n) ? ((n = n.slice())[0] += i) : (n += i), n
										);
									},
								},
							},
								...
								t.controllers.line = t.DatasetController.extend({
										...
										for (
											p &&
												...
												(l._model = {
													...
													tension: a.tension
														? a.tension
														: r.valueOrDefault(f.lineTension, d.tension),
													backgroundColor: a.backgroundColor
														? a.backgroundColor
														: f.backgroundColor || d.backgroundColor,
													borderWidth: a.borderWidth
														? a.borderWidth
														: f.borderWidth || d.borderWidth,
													borderColor: a.borderColor
														? a.borderColor
														: f.borderColor || d.borderColor,
													borderCapStyle: a.borderCapStyle
														? a.borderCapStyle
														: f.borderCapStyle || d.borderCapStyle,
													borderDash: a.borderDash
														? a.borderDash
														: f.borderDash || d.borderDash,
													...
													steppedLine: a.steppedLine
														? a.steppedLine
														: r.valueOrDefault(f.steppedLine, d.stepped),
										...
										return (
											isNaN(a.rotation)
												? (isNaN(i.pointRotation) &&
														!r.isArray(i.pointRotation)) ||
													(n = r.valueAtIndexOrDefault(i.pointRotation, e, n))
												: (n = a.rotation),
											n
										);
									},
									updateElement: function (t, e, n) {
										...
										void 0 !== u.radius &&
											...
											(a = n ? h.getBasePixel() : o.calculatePointY(d, e, c)),
											(t._xScale = f),
											(t._yScale = h),
											(t._datasetIndex = c),
											(t._index = e),
								...
								advance: function (t) {
									for (var e, n, i = this.animations, r = 0; r < i.length; )
										(n = (e = i[r]).chart),
											...
											a.callback(e.render, [n, e], n),
											a.callback(e.onAnimationProgress, [e], n),
											e.currentStep >= e.numSteps
												? (a.callback(e.onAnimationComplete, [e], n),
													(n.animating = !1),
													i.splice(r, 1))
												: ++r;
								},
								...
								o.extend(t.prototype, {
									...
									resize: function (t) {
										var e = this,
											...
											s = Math.max(
												0,
												Math.floor(a ? r / a : o.getMaximumHeight(i)),
											);
										if (
											...
											(i.style.width = r + "px"),
											(i.style.height = s + "px"),
											o.retinaScale(e, n.devicePixelRatio),
											!t)
										) {
									...
									buildOrUpdateScales: function () {
										...
										n.scales &&
											...
											o.each(a, function (n) {
												...
												e(a.position) !== e(n.dposition) &&
													(a.position = n.dposition),
													(r[s] = !0);
												var u = null;
												if (s in i && i[s].type === l)
													((u = i[s]).options = a),
														(u.ctx = t.ctx),
														(u.chart = t);
												else {
									...
									update: function (e) {
										...
										if (
											...
											(i = (n = a).options),
											o.each(n.scales, function (t) {
												l.removeBox(n, t);
											}),
											(i = o.configMerge(
												t.defaults.global,
												t.defaults[n.config.type],
												i,
											)),
									...
									updateLayout: function () {
										!1 !== c.notify(this, "beforeLayout") &&
											(l.update(this, this.width, this.height),
											c.notify(this, "afterScaleUpdate"),
											c.notify(this, "afterLayout"));
									},
									...
									updateDataset: function (t) {
										var e = this.getDatasetMeta(t),
											n = { meta: e, index: t };
										!1 !== c.notify(this, "beforeDatasetUpdate", [n]) &&
											(e.controller.update(),
											c.notify(this, "afterDatasetUpdate", [n]));
									},
									render: function (t) {
										var e = this;
										(t && "object" == typeof t) ||
										...
										if (!1 !== c.notify(e, "beforeRender")) {
											var s = e.options.animation,
												l = function (t) {
													c.notify(e, "afterRender"),
														o.callback(s && s.onComplete, [t], e);
												};
											if (
												s &&
												((void 0 !== n && 0 !== n) ||
													(void 0 === n && 0 !== s.duration))
											) {
												var u = new i({
											...
											} else e.draw(), l(new i({ numSteps: 0, chart: e }));
											return e;
										}
									},
									draw: function (t) {
									...
									drawDataset: function (t, e) {
										...
										!1 !== c.notify(this, "beforeDatasetDraw", [i]) &&
											(n.controller.draw(e),
											c.notify(this, "afterDatasetDraw", [i]));
									},
									_drawTooltip: function (t) {
										var e = this.tooltip,
											n = { tooltip: e, easingValue: t };
										!1 !== c.notify(this, "beforeTooltipDraw", [n]) &&
											(e.draw(), c.notify(this, "afterTooltipDraw", [n]));
									},
									...
									destroy: function () {
										var e,
											...
											a = i.canvas;
										for (
											i.stop(), e = 0, n = i.data.datasets.length;
											e < n;
											++e
										)
									...
									handleEvent: function (t) {
										...
										return (
											...
											(e = !o.arrayEquals(n.active, n.lastActive)),
							...
							(t.DatasetController = function (t, e) {
								...
								i.extend(t.DatasetController.prototype, {
									...
									removeHoverStyle: function (t) {
										i.merge(t._model, t.$previousStyle || {}),
									...
									? (r || (r = e._view = {}),
										...
										(function (t, e, n, a) {
											...
											for (r = 0, o = p.length; r < o; ++r)
												if (
													((c = n[(s = p[r])]),
													e.hasOwnProperty(s) || (e[s] = c),
													(l = e[s]) !== c && "_" !== s[0])
												) {
													if (
														(t.hasOwnProperty(s) || (t[s] = l),
														(d = typeof c) == typeof (u = t[s]))
													)
														if ("string" === d) {
					...
					function (t, e, n) {
						...
						e.exports = function () {
							...
							function n(n, i, a) {
								...
								return c || d
									? Math.min(c ? t(l, n, a) : h, d ? t(u, s, a) : h)
									: "none";
							}
							(r.configMerge = function () {
								...
								(r.getMaximumWidth = function (t) {
									...
									var n = e.clientWidth,
										i =
											n -
											r._calculatePadding(e, "padding-left", n) -
											r._calculatePadding(e, "padding-right", n),
								...
								(r.getMaximumHeight = function (t) {
									...
									var n = e.clientHeight,
										i =
											n -
											r._calculatePadding(e, "padding-top", n) -
											r._calculatePadding(e, "padding-bottom", n),
								...
								if (t) {
									...
									i.each(h.concat(f, p, g), function (t) {
										...
										n
											...
											S.push({ horizontal: n, minSize: e, box: t });
									});
									var M = 0,
										P = 0,
										T = 0,
									...
									i.each(h.concat(f), E),
										...
										i.each(h.concat(f), function (t) {
											var e = i.findNextWhere(S, function (e) {
												...
												n = { left: 0, right: 0, top: D, bottom: F };
										...
										this._plugins.concat(o.plugins || []).forEach(function (t) {
											if (-1 === n.indexOf(t)) {
												var e = t.id,
													o = s[e];
												!1 !== o &&
													(!0 === o && (o = a.clone(i.global.plugins[e])),
													n.push(t),
					...
					function (t, e, n) {
						...
						function d(t) {
							return r.options.toLineHeight(
								...
								r.valueOrDefault(t.fontSize, i.global.defaultFontSize),
							);
						}
						i._set("scale", {
							display: !0,
							...
							(e.exports = a.extend({
								...
								update: function (t, e, n) {
									...
									for (
										c.beforeUpdate(),
											...
											o = c.convertTicksToLabels(l) || c.ticks,
								...
								calculateTickRotation: function () {
									...
									if (i.length && t.options.display && t.isHorizontal())
										for (
											var l,
												u = r.longestText(e, a.font, i, t.longestTextCache),
												d = u,
								...
								fit: function () {
									...
									if (a.display && h) {
										...
										if (f) {
											...
											0 !== t.labelRotation
												? ((t.paddingLeft =
														"bottom" === i.position ? k * S + 3 : k * y + 3),
													(t.paddingRight =
														"bottom" === i.position ? k * y + 3 : k * M + 3))
												: ((t.paddingLeft = S / 2 + 3),
								...
								draw: function (t) {
									...
									if (n.display) {
										var a = e.ctx,
											...
											_ =
												"bottom" === n.position ? e.top + T : e.bottom - w - T,
											D =
												"bottom" === n.position ? e.top + T + w : e.bottom + T;
										if (
											(r.each(m, function (i, a) {
												if (!r.isNullOrUndef(i.label)) {
													...
													n.offset === h.offsetGridLines
														...
														: ((u = r.valueAtIndexOrDefault(h.lineWidth, a)),
															(c = r.valueAtIndexOrDefault(h.color, a)),
															(d = r.valueOrDefault(
																h.borderDash,
																o.borderDash,
															)),
												...
												if (
													...
													if (r.isArray(n))
														for (
															var i = n.length,
																o = 1.5 * b.size,
																l = e.isHorizontal() ? 0 : (-o * (i - 1)) / 2,
																u = 0;
															u < i;
															++u
														)
															a.fillText("" + n[u], 0, l), (l += o);
											...
											if (g)
												...
												(F = V ? e.left + R + S.top : e.right - R - S.top),
										...
										if (h.drawBorder) {
											...
											g
												? ((E = W = "top" === n.position ? e.bottom : e.top),
													(E += B),
													(W += B))
												: ((z = N = "left" === n.position ? e.right : e.left),
													(z += B),
													(N += B)),
												a.beginPath(),
												a.moveTo(z, E),
						...
						(e.exports = a.extend({
							...
							getBody: function (t, e) {
								...
								return (
									r.each(t, function (t) {
										...
										l(r.before, u(i.beforeLabel.call(n, t, e))),
											l(r.lines, i.label.call(n, t, e)),
											l(r.after, u(i.afterLabel.call(n, t, e))),
											a.push(r);
									}),
									a
								);
									...
									h.filter &&
										...
										(b = (function (t, e, n, i) {
											...
											return (
												...
												"top" === c
													? (r += d)
													: (r -= "bottom" === c ? e.height + d : e.height / 2),
												"center" === c
													? "left" === u
														? (a += d)
														: "right" === u && (a -= d)
							...
							drawTitle: function (t, e, n, i) {
								...
								if (a.length) {
									...
									var o,
										...
										c = e.titleSpacing;
									for (
										n.fillStyle = s(e.titleFontColor, i),
											n.font = r.fontString(
												u,
												e._titleFontStyle,
												e._titleFontFamily,
										...
										n.fillText(a[o], t.x, t.y),
											(t.y += u + c),
											o + 1 === a.length && (t.y += e.titleMarginBottom - c);
								}
							},
									...
									r.each(l, function (o, l) {
										...
										(n.fillStyle = u),
											...
											r.each(o.lines, function (r) {
												d &&
													((n.fillStyle = s(e.legendColorBackground, i)),
													n.fillRect(t.x, t.y, a, a),
													(n.lineWidth = 1),
													(n.strokeStyle = s(e.labelColors[l].borderColor, i)),
													n.strokeRect(t.x, t.y, a, a),
													(n.fillStyle = s(
														e.labelColors[l].backgroundColor,
														i,
													)),
													n.fillRect(t.x + 1, t.y + 1, a - 2, a - 2),
													(n.fillStyle = u)),
													c(r);
											}),
											r.each(o.after, c);
							...
							drawFooter: function (t, e, n, i) {
								...
								a.length &&
									...
									(n.textBaseline = "top"),
									(n.fillStyle = s(e.footerFontColor, i)),
									(n.font = r.fontString(
										e.footerFontSize,
										e._footerFontStyle,
										e._footerFontFamily,
							...
							drawBackground: function (t, e, n, i, a) {
								(n.fillStyle = s(e.backgroundColor, a)),
									(n.strokeStyle = s(e.borderColor, a)),
								...
								n.beginPath(),
									...
									n.lineTo(l + c - h, u),
									n.quadraticCurveTo(l + c, u, l + c, u + h),
									"center" === o && "right" === r && this.drawCaret(t, i),
									n.lineTo(l + c, u + d - h),
									n.quadraticCurveTo(l + c, u + d, l + c - h, u + d),
								...
								draw: function () {
									...
									for (
										this._loop && u.length && u.push(u[0]),
											s.save(),
											s.lineCap = a.borderCapStyle || c.borderCapStyle,
											s.setLineDash &&
												s.setLineDash(a.borderDash || c.borderDash),
											s.lineDashOffset =
												a.borderDashOffset || c.borderDashOffset,
											s.lineJoin = a.borderJoinStyle || c.borderJoinStyle,
											s.lineWidth = a.borderWidth || c.borderWidth,
											...
											0 === t
												...
												: ((n = -1 === d ? n : u[d]),
													i.skip ||
														((d !== t - 1 && !l) || -1 === d
															? s.moveTo(i.x, i.y)
															: r.canvas.lineTo(s, n._view, e._view),
														(d = t)));
									s.stroke(), s.restore();
								},
							}));
								...
								draw: function (t) {
									...
									e.skip ||
										((void 0 === t ||
											...
											r.canvas.drawPoint(a, s, u, c, d, l)));
								},
							}));
					},
					{ 26: 26, 27: 27, 46: 46 },
										...
										switch (
											...
											case "rectRounded":
												var h = n / Math.SQRT2,
													...
													p = -h,
													g = Math.SQRT2 * n;
												this.roundedRect(t, f, p, g, g, 0.425 * n);
												break;
											case "rectRot":
												(d = (1 / Math.SQRT2) * n),
													t.moveTo(-d, 0),
									...
									u &&
										...
										(function (t, e, n, i, a, r) {
											...
											for (t.beginPath(), o = 0, s = g + !!r; o < s; ++o)
												(c = n((u = e[(l = o % g)]._view), l, i)),
													(f = d(u)),
													(p = d(c)),
													f && p
														? ((y = v.push(u)), (x = b.push(c)))
														: y &&
															x &&
															(m
																? (f && v.push(u), p && b.push(c))
																: (h(t, v, b, y, x),
																	(y = x = 0),
																	(v = []),
																	(b = [])));
							...
							fit: function () {
								...
								if (
									...
									if (((o.font = f), m)) {
										...
										(o.textAlign = "left"),
											(o.textBaseline = "top"),
											r.each(t.legendItems, function (e, i) {
												var a = l(n, c) + c / 2 + o.measureText(e.text).width;
												v[v.length - 1] + a + n.padding >= t.width &&
													((b += c + n.padding), (v[v.length] = t.left)),
													(p[i] = { left: 0, top: 0, width: a, height: c }),
										...
										r.each(t.legendItems, function (t, e) {
											...
											C + S > g.height &&
												((w += k + n.padding), x.push(k), (k = 0), (C = 0)),
												(k = Math.max(k, i)),
												(C += S),
									...
									r.each(t.legendItems, function (i, l) {
										...
										x
											? m + g >= s &&
												((v = c.y += w),
												c.line++,
												(m = c.x = t.left + (s - u[c.line]) / 2))
											: v + w > t.bottom &&
												((m = c.x = m + t.columnWidths[c.line] + n.padding),
												(v = c.y = t.top + n.padding),
												c.line++),
											(function (t, n, i) {
												if (!(isNaN(b) || b <= 0)) {
													d.save(),
														(d.fillStyle = h(i.fillStyle, a.defaultColor)),
														(d.lineCap = h(i.lineCap, o.borderCapStyle)),
														(d.lineDashOffset = h(
															i.lineDashOffset,
															o.borderDashOffset,
														)),
														(d.lineJoin = h(i.lineJoin, o.borderJoinStyle)),
														(d.lineWidth = h(i.lineWidth, o.borderWidth)),
														(d.strokeStyle = h(i.strokeStyle, a.defaultColor));
													var s = 0 === h(i.lineWidth, o.borderWidth);
													if (
														(d.setLineDash &&
															d.setLineDash(h(i.lineDash, o.borderDash)),
							...
							beforeUpdate: function (t) {
								...
								e
									? (r.mergeIf(e, i.global.legend),
										n ? (o.configure(t, n, e), (n.options = e)) : c(t, e))
									: n && (o.removeBox(t, n), delete t.legend);
							},
							...
							draw: function () {
								...
								if (a.display) {
									var s,
										l,
										u,
										c = n(a.fontSize, o.defaultFontSize),
						...
						e.exports = {
							...
							beforeUpdate: function (t) {
								var e = t.options.title,
									n = t.titleBlock;
								e
									? (r.mergeIf(e, i.global.title),
										n ? (o.configure(t, n, e), (n.options = e)) : u(t, e))
									: n && (o.removeBox(t, n), delete t.titleBlock);
							},
						};
					},
					{ 26: 26, 27: 27, 31: 31, 46: 46 },
								...
								n = t.LinearScaleBase.extend({
									...
									getPixelForValue: function (t) {
										...
										return e.isHorizontal()
											? e.left + (e.width / a) * (i - n)
											: e.bottom - (e.height / a) * (i - n);
									},
									getValueForPixel: function (t) {
										var e = this,
											n = e.isHorizontal(),
									...
									var t = this,
										...
										r = (t.ticks = (function (t, e) {
											...
											if (t.stepSize && t.stepSize > 0) r = t.stepSize;
												...
												(r = i.niceNum(s / (t.maxTicks - 1), !0)),
													void 0 !== (a = t.precision) &&
														((n = Math.pow(10, a)), (r = Math.ceil(r * n) / n));
											}
											var l = Math.floor(e.min / r) * r,
												u = Math.ceil(e.max / r) * r;
											i.isNullOrUndef(t.min) ||
												i.isNullOrUndef(t.max) ||
												!t.stepSize ||
												(i.almostWhole((t.max - t.min) / t.stepSize, r / 1e3) &&
													((l = t.min), (u = t.max)));
											var c = (u - l) / r;
											(c = i.almostEquals(c, Math.round(c), r / 1e3)
												? Math.round(c)
												: Math.ceil(c)),
												(a = 1),
												r < 1 &&
													((a = Math.pow(10, 1 - Math.floor(i.log10(r)))),
													(l = Math.round(l * a) / a),
													(u = Math.round(u * a) / a)),
												o.push(void 0 !== t.min ? t.min : l);
											for (var d = 1; d < c; ++d)
												o.push(Math.round((l + d * r) * a) / a);
										...
										(t.min = n(e.min, t.min)),
											...
											t.min === t.max &&
												(0 !== t.min && null !== t.min
													? ((t.min = Math.pow(
															10,
															Math.floor(i.log10(t.min)) - 1,
														)),
														(t.max = Math.pow(
															10,
															Math.floor(i.log10(t.max)) + 1,
														)))
													: ((t.min = 1), (t.max = 10))),
											null === t.min &&
												(t.min = Math.pow(10, Math.floor(i.log10(t.max)) - 1)),
											null === t.max &&
												(t.max =
													0 !== t.min
														? Math.pow(10, Math.floor(i.log10(t.min)) + 1)
														: 10),
											null === t.minNotZero &&
												(t.min > 0
													? (t.minNotZero = t.min)
										...
										var t = this,
											...
											r = (t.ticks = (function (t, e) {
												...
												do {
													r.push(s),
														10 == ++a && ((a = 1), (c = ++n >= 0 ? 1 : c)),
														(s = Math.round(a * Math.pow(10, n) * c) / c);
												} while (n < l || (n === l && a < u));
												var d = o(t.max, s);
												return r.push(d), r;
											})(a, t));
									...
									getValueForPixel: function (e) {
										...
										if (
											(l
												...
												: ((a = s.start), (r = s.end)),
											s.isHorizontal()
												? ((n = s.width), (o = l ? s.right - e : e - s.left))
												: ((n = s.height), (o = l ? e - s.top : s.bottom - e)),
											o !== a)
										) {
											if (0 === a) {
												var d = i.getValueOrDefault(
							...
							var t = o.extend({
								...
								determineDataLimits: function () {
									...
									w.length &&
										...
										(b = b === l ? +i().endOf(g) + 1 : b),
										(c.min = Math.min(v, b)),
										(c.max = Math.max(v + 1, b)),
										(c._horizontal = c.isHorizontal()),
										(c._table = []),
										(c._timestamps = { data: y, datasets: x, labels: w });
								},
								buildTicks: function () {
									var t,
										e,
										...
										(a._unit =
											...
											(function (t, e, n, a) {
												...
												for (r = d.length - 1; r >= d.indexOf(e); r--)
													if (((o = d[r]), c[o].common && s.as(o) >= t.length))
														return o;
												return d[e ? d.indexOf(e) : 0];
											})(h, l.minUnit, a.min, a.max)),
										(a._majorUnit = v(a._unit)),
										(a._table = (function (t, e, n, i) {
											...
											var a,
												...
												c = [e];
											for (a = 0, r = t.length; a < r; ++a)
												(s = t[a]) > e && s < n && c.push(s);
											for (c.push(n), a = 0, r = c.length; a < r; ++a)
												(l = c[a + 1]),
													(o = c[a - 1]),
													(s = c[a]),
													(void 0 !== o &&
								...
								getLabelForIndex: function (t, e) {
									...
									return (
										...
										i.tooltipFormat
											...
											: "string" == typeof a
												? a
												: g(a, i).format(this._labelFormat)
									);
								},
				...
				init: function () {
					...
					function i() {
						...
						t(".wow").each(function () {
							if (
								...
								((n + i - 100 > a(this) && i < a(this)) ||
									(n + i - 100 > a(this) + t(this).height() &&
										i < a(this) + t(this).height()) ||
									(n + i == t(document).height() &&
					...
					t(".wow").each(function () {
						...
						t(".wow").each(function () {
							...
							i
								? ((i = t(this).attr("data-wow-delay").slice(0, -1)),
									parseFloat(i),
									t(this).addClass("animated"),
									t(this).css({ visibility: "visible" }),
									t(this).css({ "animation-delay": i + "s" }),
									t(this).css({ "animation-name": e[n] }))
								: (t(this).addClass("animated"),
									t(this).css({ visibility: "visible" }),
									t(this).css({ "animation-name": e[n] }));
						});
		...
		var l = {
				...
				show: function (t, e, n) {
					...
					i.classList.add("waves-notransition"),
						i.setAttribute("style", s(h)),
						i.classList.remove("waves-notransition"),
						(h["-webkit-transform"] = c + " " + d),
						(h["-moz-transform"] = c + " " + d),
						(h["-ms-transform"] = c + " " + d),
						(h["-o-transform"] = c + " " + d),
						(h.transform = c + " " + d),
		...
		return (
			...
			(t.attach = function (t, e) {
				...
				for (var o = 0, s = t.length; o < s; o++)
					(a = (i = t[o]).tagName.toLowerCase()),
						-1 !== ["input", "img"].indexOf(a) &&
							(u[a](i), (i = i.parentElement)),
	...
	var e,
		...
		o = function () {
			...
			if (e.val().length) {
				...
				n.html(r),
					n.css("width", e.is(":visible") ? e.width() : t(window).width() / 2),
				...
				e.find(".nested").hide(),
					...
					i.on("click", function () {
						...
						e.hasClass("opened")
							...
							: (i.removeClass("opened"), e.addClass("opened"));
					});
			}
				...
				e.find(".nested").hide(),
					...
					r.on("click", function () {
						...
						e.hasClass("opened")
							...
							: (r.removeClass("opened"), e.addClass("opened"));
					});
			}
		};
	})(jQuery),
			...
			init: function (n, i) {
				...
				for (
					...
					Object.defineProperty(h, "bsCustomFileInput", {
						...
						o.call(h),
						h.addEventListener(u, o);
				}
				for (var f = 0, p = r.length; f < p; f++)
					r[f].addEventListener(l, s),
						Object.defineProperty(r[f], "bsCustomFileInput", {
							value: !0,
							writable: !0,
						});
			},
