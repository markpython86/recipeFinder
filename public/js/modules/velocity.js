...
jQuery.Velocity
	...
	: (!((e) => {
			...
			if (!e.jQuery) {
				var r = (e, t) => new r.fn.init(e, t);
				(r.isWindow = (e) => null != e && e == e.window),
					(r.type = (e) =>
						null == e
							? e + ""
							: "object" == typeof e || "function" == typeof e
								? n[i.call(e)] || "object"
								: typeof e),
					(r.isArray = Array.isArray || ((e) => "array" === r.type(e))),
					(r.isPlainObject = (e) => {
						var t;
			...
			((e, t, r, a) => {
				...
				function p(e, t) {
					...
					for (
						...
						if (
							...
							var d = !1;
							f.each(S.Lists.transforms3D, (e, t) => {
						...
						s && o.loop !== !0 && s(n),
							i(p) &&
								o.loop === !0 &&
								!t &&
								(f.each(i(p).tweensContainer, (e, t) => {
									/^rotate/.test(e) &&
				...
				var f,
					...
					m = {
						...
						isSVG: (e) => t.SVGElement && e instanceof t.SVGElement,
						isEmptyObject: (e) => {
				...
				var x = (() => {
					...
					return function a(e, t, n) {
						...
						return o ? (e) => u[(e * (u.length - 1)) | 0] : c;
					};
				})();
				(b.Easings = {
					linear: (e) => e,
					swing: (e) => 0.5 - Math.cos(e * Math.PI) / 2,
					spring: (e) => 1 - Math.cos(4.5 * e * Math.PI) * Math.exp(6 * -e),
				}),
					f.each(
						[
				...
				var S = (b.CSS = {
						...
						register: () => {
							...
							for (var e = 0; e < S.Lists.transformsBase.length; e++)
								!(() => {
									...
									S.Normalizations.registered[t] = (e, r, n) => {
										switch (e) {
											case "name":
												return "transform";
											case "extract":
					...
					Names: {
						camelCase: (e) => e.replace(/-(\w)/g, (e, t) => t.toUpperCase()),
						SVGAttribute: (e) => {
							...
							for (
								...
								if (
									((n =
										0 === r
											? e
											: t[r] + e.replace(/^\w/, (e) => e.toUpperCase())),
					...
					Values: {
						hexToRgb: (e) => {
							...
							return (
								(e = e.replace(r, (e, t, r, a) => t + t + r + r + a + a)),
								(t = a.exec(e)),
								t
				...
				var P = function () {
					...
					function n() {
							...
							function h() {
								...
								if (n && a)
									...
									b.init(u),
										...
										f.each(["overflow", "overflowX", "overflowY"], (e, t) => {
						...
						var n,
							...
							l = {};
						switch (
							(i(this) === a && b.init(this),
							parseFloat(s.delay) &&
								s.queue !== !1 &&
								f.queue(this, s.queue, (e) => {
						...
						b.mock !== !1 &&
							...
							s.display !== a &&
								...
								"auto" === s.display &&
									(s.display = b.CSS.Values.getDisplayType(this))),
							s.visibility !== a &&
								null !== s.visibility &&
															...
															a === n &&
																...
																"stop" === y
																	? (i(a) &&
																			i(a).tweensContainer &&
																			o !== !1 &&
																			f.each(i(a).tweensContainer, (e, t) => {
				...
				return (
					...
					f.each(["Down", "Up"], (e, t) => {
						b.Redirects["slide" + t] = (e, r, n, o, i, s) => {
							var l = f.extend({}, r),
								u = l.begin,
								c = l.complete,
								p = {
