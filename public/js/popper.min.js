 ...
 */ ((e, t) => {
	...
	function _(e, t, o, n) {
		var i = [0, 0],
			...
			s = p.indexOf(C(p, (e) => -1 !== e.search(/,|\s/)));
		p[s] &&
			-1 === p[s].indexOf(",") &&
			console.warn(
	...
	var i = ee && window.Promise,
		...
		de = (() => {
			...
			return (t, o, n) => (o && e(t.prototype, o), n && e(t, n), t);
		})(),
		ae = (e, t, o) => (
			t in e
			...
			function t(o, n) {
				...
				se(this, t),
					...
					(this.modifiers = Object.keys(this.options.modifiers)
						.map((e) => le({ name: e }, this.options.modifiers[e]))
